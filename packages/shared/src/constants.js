...
export function collectibleBudget(w, h) {
...
export const SAFE_WEIGHTS = [
    ["xp_orb", 0.7],
    ["speed_up", 0.3],
];
export const WAR_WEIGHTS = [
    ["farm_event", 0.85],
    ["box", 0.15],
];
...
export function pickWeighted(rnd, weights) {
...
export function lossFraction(level) {
    if (level <= 3)
        return MIN_LOSS_FRACTION;
