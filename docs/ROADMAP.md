...
| **M1 — Combate & risco** | 1ª arma placeholder (projétil), dano, morte/respawn, nível sobe (coleta/kill) e desce (morte, pode zerar), força escala p/ matar veteranos, controle touch (joystick virtual) | ⬜ |
