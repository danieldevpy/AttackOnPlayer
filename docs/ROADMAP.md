...
| **M1 — Mundo aberto, crescimento & combate** | Base via `docs/BACKLOG.md` (T-001..T-008b) pronta: campo aberto, props/zonas, XP/atributos, coletáveis ricos, persistência scaffold, lançadores, morte/respawn/perda, debug F3, bots de combate. Em execução: `specs/SPEC-0003-facing-mira-gatilhos.md` (T-009..T-013 — facing sincronizado, mira ≠ gatilho, ganchos de mobilidade). Pendente: T-OPTIONAL 1 (balance/métricas), touch | 🔄 por tasks |
